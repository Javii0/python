...
def add():
     CSV.initialize_csv()
     date = get_date("Enter date of transaction (in mm-dd-yyyy formant) or press enter for today's date: ", allow_default=True)
     amount = get_amount()
...
def main():
    while True:
        ...
        print("2. View Transaction and summary within date range")
        print("3. Exit")
        ...
        if choice == "1":
            ...
            if input("Do you want to plot data? y/n ").lower() == "y":
